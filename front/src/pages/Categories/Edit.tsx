    ...
    <div className="modal fade" id="editCategoriesModal" tabIndex={-1} role="dialog">
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <form onSubmit={editSubmit} className="form-horizontal" id="editCategoriesForm">
            <div className="modal-header">
              <button type="button" className="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 className="modal-title"><i className="fa fa-edit"></i> Edit Categories</h4>
            </div>
              ...
              <div className="edit-categories-result">
                <div className="form-group">
                  ...
                  <div className="col-sm-7">
                    <input value={name} onChange={(e) => setName(e.target.value)} type="text" className="form-control" id="editCategoriesName" name="editCategoriesName" autoComplete="off" />
                  </div>
                </div> {/*<!-- /form-group-->*/}	         	        
                <div className="form-group">
                  ...
                  <label className="col-sm-1 control-label">: </label>
                  <div className="col-sm-7">
                    <select value={status} onChange={(e) => setStatus(e.target.value)} className="form-control" id="editCategoriesStatus" name="editCategoriesStatus">
            ...
            <div className="modal-footer editCategoriesFooter">
              ...
              <button type="submit" className="btn btn-success" id="editCategoriesBtn" data-loading-text="Loading..."> <i className="glyphicon glyphicon-ok-sign"></i> Save Changes</button>
            </div>
            {/*<!-- /modal-footer -->*/}
          </form>
          {/*<!-- /.form -->*/}
